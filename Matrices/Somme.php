...
/**
 * @Author: cnicolas
 * @Date:   2014-08-05 11:00:40
 * @Last Modified by:   cnicolas
 * @Last Modified time: 2015-07-02 11:34:02
 */
	include 'fonctions.php';

	if ($_POST['lignesA'] === $_POST['lignesB'] && $_POST['colonnesA'] === $_POST['colonnesB']) {
		echo "<form action='resultatSomme.php' method='post' id='format'>\n";
		...
		echo "<h2>Somme A + B non calculable. Les matrices A et B doivent être de même taille</h2>";
